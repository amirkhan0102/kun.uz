...
import dastrulash.uz.kun.uz.mapper.SectionMapper;
...
public class SectionService {
    ...
    public List<SectionDTO> getAllByLang(LanguageEnum lang) {
    ...
    private SectionDTO toLangResponseDto(SectionEntity entity, LanguageEnum lang) {
        SectionDTO dto = new SectionDTO();
        dto.setId(entity.getId());
        dto.setSectionKey(entity.getSectionKey());
        switch (lang) {
